...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    // Actualiza la interfaz principal de acuerdo si hay notas o no
    ...
    private fun setupHomeRecyclerView(){
        noteAdapter = NoteAdapter() //Inicializa el adaptador de Notas
    ...
    // Implementación de OnQueryTextListener
